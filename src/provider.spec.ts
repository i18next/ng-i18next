...
import { Ii18nTranslateService, Ii18nProvider } from './interfaces';
...
describe('provider tests', () => {
    ...
    describe('Unit: jm.i18next - Provider behavior before i18next has been initialized', () => {
        ...
        let i18nextOptions: i18n.Options = {
            debug: false,
            fallbackLng: 'dev',
            lng: 'de-DE',
            resources: {
        ...
        let tOptions: i18n.TranslationOptions = {};
    ...
    describe('Unit: jm.i18next - Provider', () => {
        ...
        describe('simple strings', () => {
            ...
            it('should translate "hello" into German in default namespace ("de-DE"; default language)', () => {
                ...
                let originResStore = angular.copy(i18nextOptions.resources);
