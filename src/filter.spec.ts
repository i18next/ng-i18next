...
import { IFilterI18next, Ii18nProvider } from './interfaces';
...
describe('Unit: jm.i18next - Filter', () => {
    ...
    beforeEach(() => {
        ...
        angular.mock.module('jm.i18next', function ($i18nextProvider: Ii18nProvider) {
        ...
        inject(function (_$filter_: ng.IFilterService, _$rootScope_: ng.IRootScopeService) {
            $filter = _$filter_;
